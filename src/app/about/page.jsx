  ...
  return (
    <Container className="mt-16 sm:mt-32">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:pl-20">
          <ul role="list">
            <SocialLink href="https://x.com/claudiavanea" icon={XIcon}>
              Follow on X
            </SocialLink>
            <SocialLink href="https://github.com/cvanea" icon={GitHubIcon} className="mt-4">
              Follow on GitHub
            </SocialLink>
            <SocialLink href="https://www.linkedin.com/in/claudia-vanea/" icon={LinkedInIcon} className="mt-4">
              Follow on LinkedIn
            </SocialLink>
            <SocialLink
              href="mailto:claudia.vanea@hotmail.co.uk"
              icon={MailIcon}
              className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
            >
              claudia.vanea@hotmail.co.uk
            </SocialLink>
          </ul>
        </div>
      </div>
